...
func (a *automaton) get(b byte) {
	a.state = a.table[a.state][a.getCol(b)]
	if a.state == "in_number" {
		a.ans = a.ans*10 + int64(b-'0')
		if a.sign == 1 {
...
func (a *automaton) getCol(b byte) int {
	if b == ' ' {
		return 0
	}
	if b == '+' || b == '-' {
